...
def printFacade():
    if (usageName) and (not tariffName):
        ...
        cntv = tree.xpath(
            "/productcatalog:ProductCatalog/TariffElements/usageTariffs[@name='" + tariffName + "']/usageRules",
            namespaces=NSMAP);
        printUsagePrice(cntv)
...
tree = et.parse(open(
    "/rte/orgaroot/mrte1/si/cs/subversion/branches/OPSC-CONF-Avea_r242/LOGICAL/ProductCatalog/ProductCatalogCTNPreTariffs.xml"),
                parser)
printFacade()
print('-----------------ProductCatalogPromoPreTariff--------------------')
tree = et.parse(open(
    "/rte/orgaroot/mrte1/si/cs/subversion/branches/OPSC-CONF-Avea_r242/LOGICAL/ProductCatalog/ProductCatalogPromoPreTariff.xml"),
                parser)
printFacade()
