...
if [[ $# -ne 6&&$# -ne 7 ]] 
	...
	echo "Kullaným: $0 MSISDN oldServiceID newServiceID FlagBonusID oldServicePrice newServicePrice "
	echo ya da paketKacGunluk opsiyonel parametetresi ile:
		echo "Kullaným: $0 MSISDN oldServiceID newServiceID FlagBonusID oldServicePrice newServicePrice paketKacGunluk"
	echo "ornek kullanim:"
	echo ""
